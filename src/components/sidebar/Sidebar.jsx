  ...
  return (
    <div className="sidebar">
      <div className="sidebarItem">
        ...
        />
        <p>
        I am a final year B.Tech student having good interpersonal communication and adept skills focussing to improve quality of women by making a small contribution.
        </p>
      </div>
      <div className="sidebarItem">
